...
class StorageManager {
    ...
    Map<String,Integer> cloudIdToShort = new HashMap<>();
    ...
    void storeUsingShortCode(int shortCode, String cloudAnchorId) {
        ...
        cloudIdToShort.put(cloudAnchorId,shortCode);
    }
    ...
    int getShortCode(String cloudAnchorId){
       return cloudIdToShort.get(cloudAnchorId);
    }
}